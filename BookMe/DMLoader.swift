...
//  Naimi.kz
//
//  Created by Naimi on 03.11.15.
//  Copyright © 2015 Ino Group. All rights reserved.
//
...
class DMLoader: NSObject {
    ...
    var backgroundColor = RGBColor(0xEEEEEE)
    ...
    private func initFrame(){
        ...
        let frame = CGRect(x: (viewWidth-indicatorSize)/2, y: (viewHeight-indicatorSize)/2-indicatorSize/2, width: indicatorSize, height: indicatorSize)
        let activityIndicatorView = NVActivityIndicatorView(frame: frame,
            type: .ballRotateChase, color: Globals.main.tint)
